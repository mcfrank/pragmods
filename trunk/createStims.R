...
###########################################################################
## SECOND version of CreateExperimentalData script, used for V2 experiments

CreateExperimentalDataV2 = function(
  expt=c(),
...
######################################################################
## First version of CreateExperimentalData script, used for V1 experiments
